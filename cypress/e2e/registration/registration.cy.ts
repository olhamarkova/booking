...
describe("Registration with email", function () {
  beforeEach(function () {
    ...
    //Click on the "Register" button // this step repeats in every test, so I placed it here to follow the DRY principle
  ...
  it("A user shall be able to register with valid email and password", function () {
    ...
    //check if the captcha appears; if not, run test further, if yes - stop the test
